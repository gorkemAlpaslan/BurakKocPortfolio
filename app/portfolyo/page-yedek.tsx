...
const projects = [
  ...
  },
  {
    ...
    description: "Önde gelen bir finans kurumu için sezgisel ve güvenli bir mobil bankacılık uygulaması tasarımı.",
    imageUrl: "/placeholder.svg?height=300&width=400",
    category: "Mobile App",
  },
  {
    id: 3,
    title: "Seyahat Rezervasyon Sitesi",
    description:
      ...
      <main className="container mx-auto px-4 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-white/60 max-w-2xl mx-auto">
            Yaratıcı çözümler ve kullanıcı odaklı tasarımlarla dijital deneyimleri dönüştürüyorum.
          </p>
        </motion.div>
